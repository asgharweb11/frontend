...
const Buys = () => {
    ...
    const titlesDialog = ["محصول" , "قیمت" , "تعداد" , "مجموع" , "دانلود"]
            ...
            <Grid item xs={12}>
                <div className={style.allPosts_dataGrid_container}>
                    <div className={style.allPosts_dataGrid_title}>
                        <Typography variant="body1" component="p">خرید های من</Typography>
                    </div>
                    ...
                    >
                        <DialogTitle className={classes.dialogTitle}>
                            ...
                            >
                                ...
                                <Typography variant="h6" component="h6">فاکتور خرید های من</Typography>
                            </Box>
                        </DialogTitle>
                        <DialogContent>
                            <div className={classes.boxModel}>
                                {/* <ModelSell open={model} handle={openModel}/> */}
                                <ModelSell dataRows={rowsDialog} dataTitle={titlesDialog} page="buys"/>
                            </div>
                        </DialogContent>
